...
public class AirportReaderDW implements AirportReaderInterface {
  public List<AirportInterface> airports;
...
*/
    ...
    for (int d = 0; d < airportNames.size(); d++) {
      ...
      airports.add(new AirportDW(airportNames.get(d), paths2.get(d), pathWeightsString.get(d)));
    }
