...
public class TextUITester {
    ...
    public static void main(String[] args) {
        ...
        // pass the text to simulate a user typing as only argument.
        TextUITester tester = new TextUITester("apple\n3.14\nq\n");

        // 2. Create a Scanner, and run then run code to test here:
        run(); // (this code should read from System.in and write to System.out)

        // Note you cannot see output printed by  program between the
        // constructor call above and the checkOutput call below.

        // 3. Check whether the output printed to System.out matches expectations.
    ...
    public static void run() {
        // Note to avoid instantiating more than one Scanner reading from System.in code
    ...
    */
    ...
    /**
     * Call this method after running test code, to check whether the expected
